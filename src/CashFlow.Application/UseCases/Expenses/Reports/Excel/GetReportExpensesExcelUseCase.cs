...
public class GetReportExpensesExcelUseCase : IGetReportExpensesExcelUseCase
{
    ...
    {
        worksheet.Cell("A1").Value = ResourceReportsExpensesMessages.TITLE;
        worksheet.Cell("B1").Value = ResourceReportsExpensesMessages.DATE;
        worksheet.Cell("C1").Value = ResourceReportsExpensesMessages.PAYMENT_TYPE;
        worksheet.Cell("D1").Value = ResourceReportsExpensesMessages.AMOUNT;
        worksheet.Cell("E1").Value = ResourceReportsExpensesMessages.DESCRIPTION;
